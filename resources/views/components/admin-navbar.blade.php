      ...
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
            <img
              src="https://www.skodaperth.com.au/wp-content/uploads/2023/09/skoda_logo_v2_squared-1170x1170-1.webp"
              class="mr-3 h-8"
              alt="Flowbite Logo"
            />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Skoda Team
            </span>
          </a>
