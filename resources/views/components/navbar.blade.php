            ...
            <nav class="bg-gray-800"  x-data="{ isOpen: false }">
                ...
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="flex-shrink-0">
                        <img class="h-8 w-8" src="https://banner2.cleanpng.com/20180323/ocq/av0kyua0k.webp" alt="Your Company">
                    </div>
                    <div class="hidden md:block">
                        ...
                        <x-navlink href="/departement" :active="request()->is('departement')">Department</x-navlink>
                        </div>
                    </div>
                    </div>
                    <div class="hidden md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <div>
                            ...
                            <img class="h-8 w-8 rounded-full" src="https://upload.wikimedia.org/wikipedia/commons/f/f8/Gustaf_Larson_1950-55.jpg">
                            </button>
                        </div>
                ...
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                    <x-navlink-mobile href="/home" :active="request()->is('home')">Home</x-navlink-mobile>
                    ...
                    <x-navlink-mobile href="/departement" :active="request()->is('departement')">Department</x-navlink-mobile>
                </div>
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                    <div class="flex-shrink-0">
                        <img class="h-10 w-10 rounded-full" src="https://banner2.cleanpng.com/20180323/ocq/av0kyua0k.webp">
                    </div>
                    <div class="ml-3">
